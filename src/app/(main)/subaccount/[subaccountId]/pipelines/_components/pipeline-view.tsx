...
import { LaneDetail, PipelineDetailsWithLaneCardsTagsTickets, TicketAndTags } from "@/lib/types";
...
const PipelineView = ({lanes,pipelineId,subaccountId,pipelineDetails,updateLanesOrder,updateTicketsOrder}:Props) => {
    ...
    const handleAddLane = () => {
        setOpen(
            <CustomModal
                title="Create A Lane"
                subheading="Lanes are group of Tickets"
            >
    ...
    return(
        <DragDropContext onDragEnd={onDragEnd}>
            {/*7:31 */}
            <div className="bg-white/60 dark:bg-background/60 rounded-xl p-4 use-automation-zoom-in scrollbar-hide">
