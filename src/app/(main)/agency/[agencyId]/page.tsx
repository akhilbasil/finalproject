import SubaccountGrowthChart from "@/components/charts/subaccountgrowthchart";
import {
  Card,
  CardContent,
  CardDescription,
...
import { getAgencyTotalFunnelPages } from "@/lib/queries";
...
const Page = async ({
  ...
  const agencyStats = await getAgencyTotalFunnelPages(params.agencyId)
    ...
    <div className="relative h-full">
      ...
      <div className="flex flex-col gap-4 pb-6">
        <div className="flex gap-4 flex-col xl:!flex-row">
          ...
          <Card className="flex-1 relative">
            <CardHeader>
              <CardDescription className="text-2xl">Active Subaccounts</CardDescription>
        ...
        <Card className="flex-1 relative">
            <CardHeader>
              <CardDescription className="text-2xl">Total Pages Created across all Subaccounts</CardDescription>
              <CardTitle className="text-4xl">{agencyStats.totalFunnelPages}</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
        ...
        <Card className="flex-1 relative">
            <CardHeader>
              ...
              <CardTitle className="text-4xl">Subaccount Creation</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              <SubaccountGrowthChart agencyId={params.agencyId} />
            </CardContent>
            <GitGraph className="absolute right-4 top-4 text-muted-foreground" />
          </Card>
        </div>
      </div>
    </div>
