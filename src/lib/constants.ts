...
export const pricingCards = [
    {
      ...
      features: ['1 Sub accounts','Unlimited Team Members', 'Unlimited pipelines'],
      priceId: '',
    },
    {
      ...
      duration: 'Lifetime',
      highlight: 'Key features',
      features: ['Unlimited pipelines','Unlimited subaccounts','Unlimited Team Members','24/7 Support team'],
