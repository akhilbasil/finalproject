...
const editorReducer = (
  ...
  switch (action.type) {
    ...
    case 'SET_FUNNELPAGE_ID':
      ...
      case 'APPLY_TEMPLATE':
        const updatedEditorWithTemplate = {
          ...state.editor,
          elements: action.payload.templateElements, // Replace current elements with template
        };
      
        return {
          ...state,
          editor: updatedEditorWithTemplate,
          history: {
            ...state.history,
            history: [...state.history.history.slice(0, state.history.currentIndex + 1), { ...updatedEditorWithTemplate }],
            currentIndex: state.history.currentIndex + 1,
          },
        };
